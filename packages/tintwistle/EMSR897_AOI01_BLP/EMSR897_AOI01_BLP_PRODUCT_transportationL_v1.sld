<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" version="1.1.0">
  <NamedLayer>
    <se:Name>EMSR897_AOI01_BLP_PRODUCT_transportationL_v1</se:Name>
    <UserStyle>
      <se:Name>EMSR897_AOI01_BLP_PRODUCT_transportationL_v1</se:Name>
      <se:FeatureTypeStyle>
        ...
        <se:Rule>
          ...
          <se:Name>Highway</se:Name><se:Description>
        ...
        <se:Rule>
          <se:Abstract>REF_BLP</se:Abstract>
          <se:Name>Main road</se:Name><se:Description>
        ...
        <se:Rule>
          <se:Abstract>REF_BLP</se:Abstract>
          <se:Name>Local road</se:Name><se:Description>
        ...
        <se:Rule>
          <se:Abstract>REF_BLP</se:Abstract>
          <se:Name>Track</se:Name><se:Description>
        ...
        <se:Rule>
          <se:Abstract>REF_BLP</se:Abstract>
          <se:Name>Railway</se:Name><se:Description>
        ...
        <se:Rule>
          <se:Abstract>REF_BLP</se:Abstract>
          <se:Name>Tramway</se:Name><se:Description>
            <se:Title>Tramway</se:Title>
          </se:Description>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>simplified</ogc:PropertyName>
              <ogc:Literal>Tramway</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:LineSymbolizer>
            <se:Stroke>
